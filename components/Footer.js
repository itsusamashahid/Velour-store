    ...
    <footer style={{ backgroundColor: COLORS.ink, color: "#fff" }}>
      <div className="max-w-7xl mx-auto px-4 py-14 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div className="col-span-2 md:col-span-1">
          <div className="font-extrabold text-2xl mb-3"><span style={{ color: COLORS.accent }}>Vel</span>our</div>
          <p className="text-sm text-white/60 leading-relaxed">Fragrances for you, your home, and your car — delivered nationwide with cash on delivery.</p>
        </div>
        <div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-white/50">
          <span>© {new Date().getFullYear()} Velour. All rights reserved.</span>
